...
4. Invite with permissions: `Send Messages`, `Use Slash Commands`, `View Channels`, `Read Message History`
...
# 2. Enable specific events
/log_events event:"Message Deletions" enabled:true
/log_events event:"Voice Channel Joins" enabled:true
/log_events event:"Image/File Uploads" enabled:true
...
### **Logging Management**
- `/log_config` - Configure logging channel and settings
...
- `/voice_sessions` - Current active voice sessions
- `/voice_leaderboard` - Most active voice users *(coming soon)*
