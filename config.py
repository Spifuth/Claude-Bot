...
class BotConfig:
    ...
    def validate(cls):
        ...
        if cls.DISCORD_TOKEN and (
                len(cls.DISCORD_TOKEN) < 50 or not cls.DISCORD_TOKEN.startswith(('Bot ', 'MTA', 'MTI', 'MTU', 'MTM'))):
            invalid_vars.append("DISCORD_BOT_TOKEN (format appears invalid)")
